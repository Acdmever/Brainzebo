...
function pixE=getBaseVals(im,allt1,allt2,allt3,allt4)
    ...
    for ns=[0.0,0.1,0.2,0.5,1.0]   
        for test=1:50
            ...
            pE4(test,2)=sum([getError(im1,im2,im1t,im2tB),getError(im1,im3,im1t,im3tB),getError(im2,im3,im2tB,im3tB),getError(im1,im4,im1t,im4tB),getError(im2,im4,im2tB,im4tB),getError(im3,im4,im3tB,im4tB)]);
            ...
            pE4(test,3)=sum([getError(im1,im2,im1t,im2tC),getError(im1,im3,im1t,im3tC),getError(im2,im3,im2tC,im3tC),getError(im1,im4,im1t,im4tC),getError(im2,im4,im2tC,im4tC),getError(im3,im4,im3tC,im4tC)]);
            ...
            pE4(test,4)=sum([getError(im1,im2,im1t,im2tD),getError(im1,im3,im1t,im3tD),getError(im2,im3,im2tD,im3tD),getError(im1,im4,im1t,im4tD),getError(im2,im4,im2tD,im4tD),getError(im3,im4,im3tD,im4tD)]);
